create or replace function sf_player_points_delta_hash(
  pn_tournament_id player_points.tournament_id%type,
  pn_player_code   player_points.player_code%type,
...
begin
  select ora_hash(pn_tournament_id || '|' || pn_player_code || '|' || pn_points)
  into vn_delta_hash
  from dual;
