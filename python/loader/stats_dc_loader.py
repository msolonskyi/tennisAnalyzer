...
class StatsDCLoader(BaseLoader):
    ...
    def _init(self):
        ...
        self.CSVFILE_NAME = ''
        #self.CSVFILE_NAME = './csv/stats.csv'
        self.MODULE_NAME = 'load dc stats'
    ...
    def _parse_stats(self, url_tpl: tuple):
        try:
            ...
            try:
                ...
                json_str = json_str[json_start_pos:].replace('</pre><div class="json-formatter-container"></div></body></html>', '')
